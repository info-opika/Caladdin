...
export function buildSchedulingSystemPrompt(contextBlock: string): string {
  return [
    ...
    '- For "book a slot" or "create an event", use create_event once you have title and time (or ask for the single most useful missing piece).',
    '- NEVER say you lack create_event or other tools — they are always provided when listed under Active tools.',
